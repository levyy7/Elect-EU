...
def login_required(f):
    ...
    def decorated_function(*args, **kwargs):
        # Check if the user is authenticated (currently set to always False for testing).
...
def admin_required(f):
    ...
    @wraps(f)
    def decorated_function(*args, **kwargs):
        # Check if the user is authenticated and if the user is an admin (currently set to always False for testing).
